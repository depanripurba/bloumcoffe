...
$pdf->Cell(0, 5, 'STRUK PEMBAYARAN', '0', '1', 'C', false);
$pdf->SetFont('courier', '', 10);
...
// NEW SECTIO
$tttlakhir = $root->totalHarga;
$kembalian = $bayar-$tttlakhir;
$txtpoint = "";
$pointt = 0;
if($gunakan==1){
    $txtpoint = "Point Tidak Digunakan";
}else{
    $txtpoint = "Point Digunakan";
    $pointt = $point;
    $tttlakhir = $root->totalHarga-$pointt;
}
$pdf->SetFont('courier', '', 11);
$pdf->Cell(65, 5, $txtpoint, '0', '0', 'l', false);
$pdf->Cell(25, 5, $pointt, '0', '1', 'R', false);
...
$pdf->SetFont('courier', '', 11);
$pdf->Cell(65, 5, 'TOTAL AKHIR', '0', '0', 'l', false);
$pdf->Cell(25, 5, "Rp. ".number_format($tttlakhir), '0', '1', 'R', false);
$pdf->Cell(65, 5, 'BAYAR', '0', '0', 'l', false);
$pdf->Cell(25, 5, "Rp. ".number_format($bayar), '0', '1', 'R', false);
$pdf->Cell(65, 5, 'KEMBALIAN', '0', '0', 'l', false);
$pdf->Cell(25, 5, "Rp. ".number_format($kembalian), '0', '1', 'R', false);


// NEW SECTION
$pdf->ln(10);
$pdf->Cell(0, 5, 'Terima Kasih Sudah Berkunjung', '0', '1', 'C', false);
$pdf->Cell(0, 5, 'Kami Menantikan Kehiran Anda Kembali', '0', '1', 'C', false);
$pdf->Cell(0, 5, 'PARKIR GRATIS', '0', '1', 'C', false);
$pdf->Cell(0, 5, '======================================', '0', '1', 'C', false);
