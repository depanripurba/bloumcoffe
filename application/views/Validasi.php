      ...
      <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
          <div class="login-wrap p-4 p-md-5">
            ...
            <h3 class="text-center mb-4">Silahkan Pilih Metode Pemesanan</h3> 
              <div class="form-group">
                <center><a href="<?=base_url('login')?>" class="btn btn-success p-3 px-5">Silahkan Login</a></center>
              </div>
              <div class="form-group mt-4">
                <center><a href="<?=base_url('ValidasiController/setpengguna')?>" class="btn btn-primary p-3 px-5">Masuk Sebagai Tamu</a></center>
              </div>
          </div>
        </div>
      </div>
