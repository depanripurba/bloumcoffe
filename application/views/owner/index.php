...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?=base_url('assets/vendor/adminlte/')?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user1-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user7-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user3-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user5-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user6-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="<?=base_url('assets/vendor/adminlte/')?>dist/img/user8-128x128.jpg">
