        ...
        <div class="container">
            <div class="row justify-content-center">
              ...
              <i class="fa fa-user text-white"></i>
                        ...
                        <form action="<?= base_url('daftar/registrasi') ?>" method="POST" class="login-form">
                            <div class="form-group">
                                <label for="">Nama</label>
                                <input name="nama" type="text" class="form-control rounded-left" placeholder="Nama" required>
                            </div>
                            <div class="form-group">
                                <label for="">Tanggal Lahir</label>
                                <input name="tgl_lahir" type="date" class="form-control rounded-left" placeholder="Tanggal Lahir" required>
                            </div>
                            <div class="form-group">
                            <label for="">Nomor HP</label>
                                <input name="no_hp" type="text" class="form-control rounded-left" placeholder="Nomor HP" required>
                            </div>
                            <div class="form-group">
                            <label for="">Alamat</label>
                                <input name="alamat" type="text" class="form-control rounded-left" placeholder="Alamat" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="text-align:center">Sudah Punya Akun ?? <a href="<?= base_url('login') ?>">Login</a></div>
                            <div class="form-group">
